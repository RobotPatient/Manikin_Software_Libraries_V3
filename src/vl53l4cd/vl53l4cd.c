...
static const manikin_sensor_reg_t vl53l4cd_init_regs[] = {
    /* System config */
    { 0x2d, 0x12, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x2e, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x2f, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x30, 0x11, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x31, 0x02, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x32, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x33, 0x02, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x34, 0x08, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x35, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x36, 0x08, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x37, 0x10, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x38, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x39, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x3a, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x3b, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x3c, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x3d, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x3e, 0xff, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x3f, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x40, 0x0F, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x41, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x42, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x43, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x44, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x45, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x46, 0x20, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x47, 0x0b, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x48, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x49, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x4a, 0x02, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x4b, 0x14, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x4c, 0x21, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x4d, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x4e, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x4f, 0x05, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x50, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x51, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x52, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x53, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x54, 0xc8, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x55, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x56, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x57, 0x38, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x58, 0xff, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x59, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x5a, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x5b, 0x08, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x5c, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x5d, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x5e, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x5f, 0xcc, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x60, 0x07, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x61, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x62, 0xf1, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x63, 0x05, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x64, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x65, 0xa0, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x66, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x67, 0x80, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x68, 0x08, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x69, 0x38, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x6a, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x6b, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x6c, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x6d, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x6e, 0x0f, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x6f, 0x89, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x70, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x71, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x72, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x73, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x74, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x75, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x76, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x77, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x78, 0x07, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x79, 0x05, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x7a, 0x06, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x7b, 0x06, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x7c, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x7d, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x7e, 0x02, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x7f, 0xc7, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x80, 0xff, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x81, 0x9b, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x82, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x83, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x84, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
    { 0x85, 0x01, MANIKIN_SENSOR_REG_TYPE_WRITE }, { 0x86, 0x00, MANIKIN_SENSOR_REG_TYPE_WRITE },
...
int
VL53L4CD_SetRangeTiming (manikin_sensor_ctx_t *ctx,
                         ...
                         uint32_t              inter_measurement_ms)
{
    ...
    if ((timing_budget_ms < (uint32_t)10) || (timing_budget_ms > (uint32_t)200)
        || (status != (uint8_t)0))
    {
    ...
    else if (inter_measurement_ms > timing_budget_ms)
    {
        status |= manikin_i2c_read_reg16(
            ctx->i2c, ctx->i2c_addr, VL53L4CD_RESULT__OSC_CALIBRATE_VAL, (uint8_t *)&clock_pll);
    ...
    if (status != (uint8_t)MANIKIN_STATUS_ERR_NULL_PARAM)
    {
        ...
        status
            |= manikin_i2c_write_reg16(ctx->i2c, ctx->i2c_addr, VL53L4CD_RANGE_CONFIG_A, ms_byte);
        ...
        ms_byte = (uint16_t)(ms_byte << 8) + (uint16_t)(ls_byte & (uint32_t)0xFF);
        status
            |= manikin_i2c_write_reg16(ctx->i2c, ctx->i2c_addr, VL53L4CD_RANGE_CONFIG_B, ms_byte);
    }
...
vl53l4cd_init_sensor (manikin_sensor_ctx_t *sensor_ctx)
{
    ...
    MANIKIN_ASSERT(
        HASH_VL53L4CD, (status == MANIKIN_STATUS_OK), MANIKIN_STATUS_ERR_SENSOR_INIT_FAIL);
    status
        = manikin_i2c_write_reg(sensor_ctx->i2c, sensor_ctx->i2c_addr, VL53L4CD_SYSTEM_START, 0x80);
