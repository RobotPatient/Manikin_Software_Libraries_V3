...
bhi360_init_sensor (manikin_sensor_ctx_t *sensor_ctx)
{
    ...
    //    uint8_t data = 0;
    //    data = manikin_i2c_read_reg(sensor_ctx->i2c, sensor_ctx->i2c_addr,
    //    ADS7138_REG_SYSTEM_STATUS);
    //
...
bhi360_read_sensor (manikin_sensor_ctx_t *sensor_ctx, uint8_t *read_buf)
{
    ...
    //    MANIKIN_ASSERT(HASH_BMM350, bytes_read == ADS7138_READ_BUF_SIZE,
    //    MANIKIN_STATUS_ERR_READ_FAIL); status = manikin_i2c_write_reg16(sensor_ctx->i2c,
    //                                     sensor_ctx->i2c_addr,
    //                                     ADS7138_REG_SEQUENCE_CFG,
