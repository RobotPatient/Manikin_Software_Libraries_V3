...
const manikin_sensor_reg_t init_regs[] = {
    ...
    { ADS7138_REG_PIN_CFG, (0x0 | ADS7138_OPCODE_SET_BIT << 8), MANIKIN_SENSOR_REG_TYPE_WRITE },
    /* Set cal bit */
    { ADS7138_REG_GENERAL_CFG,
      (0x02 | ADS7138_OPCODE_SET_BIT << 8),
      MANIKIN_SENSOR_REG_TYPE_WRITE },
    /* Set all adc channels as inputs. enabled in scanning sequence. */
    { ADS7138_REG_AUTO_SEQUENCE_CH_SEL,
      (0xFF | ADS7138_OPCODE_SET_BIT << 8),
      MANIKIN_SENSOR_REG_TYPE_WRITE },
    /* Set Auto sequence mode on = 1. And 4th for sequence start. */
    { ADS7138_REG_SEQUENCE_CFG,
      (0x01 | ADS7138_OPCODE_SET_BIT << 8),
      MANIKIN_SENSOR_REG_TYPE_WRITE }
};
