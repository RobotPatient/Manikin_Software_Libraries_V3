...
DEFINE_FAKE_VALUE_FUNC2(uint32_t, i2c_hal_init, manikin_i2c_inst_t, uint32_t);
...
DEFINE_FAKE_VALUE_FUNC1(uint32_t, i2c_hal_deinit, manikin_i2c_inst_t);

DEFINE_FAKE_VALUE_FUNC1(uint32_t, i2c_hal_bus_reset, manikin_i2c_inst_t);
DEFINE_FAKE_VALUE_FUNC0(uint32_t, i2c_hal_bus_recover);
